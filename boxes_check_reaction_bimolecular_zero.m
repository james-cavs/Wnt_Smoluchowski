function [A,B,C,Na_new,Nb_new,Nc_new] = boxes_check_reaction_bimolecular_zero(A,B,C,Pf,rho2,Da,Db,Nc,box_count_x,box_count_y,box_count_z,spacing)
    ...
    if ~isempty(ETA2)
        ...
        if ~isempty(ETA3)
            ...
            for i=1:size(ETA3,1)
                ...
                C(Nc+i,:)=(A(ETA3(i,1),1:3)/Da+B(ETA3(i,2),1:3)/Db)/(1/(1/Da+1/Db));
